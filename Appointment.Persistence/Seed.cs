...
public static class Seed
{
    public static async Task SeedData(DataContext context, UserManager<AppUser> userManager)
    {
        ...
        if (!context.TimeSlots.Any())
        {
            ...
            {
                Id = 1, Master = master1, DayOfWeek = DayOfWeek.Monday, StartTime = new TimeOnly(9, 30),
                EndTime = new TimeOnly(10, 0)
            };
            
            var slot2 = new TimeSlot
            {
                Id = 2, Master = master1, DayOfWeek = DayOfWeek.Monday, StartTime = new TimeOnly(10, 0),
                EndTime = new TimeOnly(10, 0)
            };
            
            var slot3 = new TimeSlot
            {
                Id = 3, Master = master1, DayOfWeek = DayOfWeek.Monday, StartTime = new TimeOnly(10, 30),
                EndTime = new TimeOnly(10, 0)
            };
            
            var slot4 = new TimeSlot
            {
                Id = 4, Master = master1, DayOfWeek = DayOfWeek.Monday, StartTime = new TimeOnly(11, 00),
                EndTime = new TimeOnly(10, 0)
            };
            
            var slot5 = new TimeSlot
            {
                Id = 5, Master = master1, DayOfWeek = DayOfWeek.Monday, StartTime = new TimeOnly(11, 30),
                EndTime = new TimeOnly(10, 0)
            };
            
            var slot6 = new TimeSlot
            {
                Id = 6, Master = master1, DayOfWeek = DayOfWeek.Monday, StartTime = new TimeOnly(12, 0),
                EndTime = new TimeOnly(10, 0)
            };
            
            var slot7 = new TimeSlot
            {
                Id = 7, Master = master1, DayOfWeek = DayOfWeek.Monday, StartTime = new TimeOnly(12, 30),
                EndTime = new TimeOnly(10, 0)
            };
